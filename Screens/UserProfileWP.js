...
export default function UserProfileWP({ navigation }) {
   const goToNext = () => {
    ...
    return(
        <View style={styles.container}>
         ...
         <View style={styles.optionBar}>
            <Text style={styles.headopt1}> Programs</Text>
         ...
         <ScrollView> 
             <View>
                <Text style={styles.head1}> Whole Body</Text>
             </View>
             <View>
             ...
             <View>
                <Text style={styles.head1}> Push Up</Text>
             </View>
             <View>
               <View style={styles.imageShape}/>
             </View>
